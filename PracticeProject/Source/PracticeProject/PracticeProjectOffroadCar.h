...
#include "PracticeProjectOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class PRACTICEPROJECT_API APracticeProjectOffroadCar : public APracticeProjectPawn
{
	GENERATED_BODY()
