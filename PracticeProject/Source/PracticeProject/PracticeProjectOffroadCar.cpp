#include "PracticeProjectOffroadCar.h"
#include "PracticeProjectOffroadWheelFront.h"
#include "PracticeProjectOffroadWheelRear.h"
...
APracticeProjectOffroadCar::APracticeProjectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPracticeProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPracticeProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPracticeProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPracticeProjectOffroadWheelRear::StaticClass();
