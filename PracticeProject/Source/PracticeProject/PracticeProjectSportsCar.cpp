...
#include "PracticeProjectSportsCar.h"
#include "PracticeProjectSportsWheelFront.h"
#include "PracticeProjectSportsWheelRear.h"
...
APracticeProjectSportsCar::APracticeProjectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPracticeProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPracticeProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPracticeProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPracticeProjectSportsWheelRear::StaticClass();
